...
# Check for the key in Streamlit's secrets management
...
# Stop the app if the key is still not found
...
# Streamlit UI
# -------------------------
st.title("🏘️ Property Data RAG — Streamlit Demo")
...
with col2:
    ...
    min_price, max_price = st.slider("Price range ($)", 0, 10000000, (0, 10000000), step=5000)
        ...
        if idx is None or meta is None:
            ...
            if analytic_ans:
                ...
                if len(retrieved_df) == 0:
                    ...
                    answer = synthesize_answer_with_context(query, retrieved_df, use_openai and openai.api_key is not None)
